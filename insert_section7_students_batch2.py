...
def insert_section7_batch2():
    ...
    with app.app_context():
        ...
        print(f"Adding Batch 2 students to {scds_school.name}, {section7.name} (ID: {section7.id})")

        # Load students from JSON
        with open('section7_students_batch2.json', 'r') as f:
        ...
        db.session.commit()
        print(f"\nFinished! Added {added_count} batch 2 students to Section 7, skipped {skipped_count}.")

if __name__ == "__main__":
    insert_section7_batch2()
