...
def seed_db():
    with app.app_context():
        ...
        s3_courses = [
            ...
            Course(section_id=sec3.id, name='Python and Data Structure', code='CS202', teacher_id=teacher_nitish.id, credits=4),
        ...
        s4_courses = [
            ...
            Course(section_id=sec4.id, name='PDS Lab Sec4', code='CS102L', teacher_id=teacher_arjun.id, credits=4),
        ...
        sec1_tt = [
            ...
            (1, '03:50 PM', '05:15 PM', 'PDS Lab', 'Computer Lab', 'var(--accent-color)', 'Arjun Singh Gangwar', 'Period 2'),
            ...
            (4, '02:10 PM', '03:35 PM', 'PDS Lab', 'Computer Lab', 'var(--accent-color)', 'Arjun Singh Gangwar', 'Period 2'),
        ]
        ...
        sec2_tt = [
            ...
            (1, '12:20 PM', '01:40 PM', 'PDS Lab', 'Computer Lab', 'var(--accent-color)', 'Arjun Singh Gangwar', 'Period 2'),
            ...
            (4, '10:40 AM', '12:10 PM', 'PDS Lab', 'Computer Lab', 'var(--accent-color)', 'Arjun Singh Gangwar', 'Period 1'),
            (4, '12:40 PM', '02:05 PM', 'Introduction to Data Structures', 'AB2 - 202', 'var(--success-color)', 'Nitish Rana', 'Period 2'),
        ]

        sec3_tt = [
            (0, '10:40 AM', '12:10 PM', 'Discrete Mathematics', 'AB2 - 203', 'var(--primary-color)', 'Tamilarasi', 'Period 1'),
            (0, '02:15 PM', '03:40 PM', 'Indian Constitution and Democracy', 'AB2 - 202', '#a78bfa', 'Ankita Kushwaha', 'Period 2'),
            (0, '03:50 PM', '05:15 PM', 'Python and Data Structure', 'Computer Lab', 'var(--accent-color)', 'Nitish Rana', 'Period 3'),
            (1, '09:00 AM', '10:30 AM', 'Introduction to Data Structures', 'AB1 - 101', 'var(--success-color)', 'Vishal Singh', 'Period 1'),
            (1, '12:15 PM', '01:45 PM', 'Environment and Sustainability', 'AB1 - Moot Court Hall', 'var(--warning-color)', 'Kishore Kumar Kabirdasan', 'Period 2'),
            (2, '09:00 AM', '10:30 AM', 'Discrete Mathematics', 'AB2 - 203', 'var(--primary-color)', 'Tamilarasi', 'Period 1'),
            (2, '02:15 PM', '03:40 PM', 'Indian Constitution and Democracy', 'AB2 - 207', '#a78bfa', 'Ankita Kushwaha', 'Period 2'),
            (3, '09:00 AM', '10:30 AM', 'Programming in Python', 'AB2 - 207', '#f472b6', 'Ujjwal Verma', 'Period 1'),
            (3, '12:20 PM', '01:40 PM', 'Python and Data Structure', 'Computer Lab', 'var(--accent-color)', 'Nitish Rana', 'Period 2'),
            (4, '10:40 AM', '12:10 PM', 'Programming in Python', 'AB2 - 202', '#f472b6', 'Ujjwal Verma', 'Period 1'),
            (4, '02:15 PM', '03:40 PM', 'Introduction to Data Structures', 'AB2 - 202', 'var(--success-color)', 'Vishal Singh', 'Period 2'),
            (4, '03:50 PM', '05:15 PM', 'Environment and Sustainability', 'AB2 - 202', 'var(--warning-color)', 'Kishore Kumar Kabirdasan', 'Period 3'),
        ]
        ...
        sec4_tt = [
            ...
            (2, '09:00 AM', '10:30 AM', 'PDS Lab Sec4', 'Computer Lab', 'var(--accent-color)', 'Arjun Singh Gangwar', 'Period 1'),
            (2, '10:40 AM', '12:10 PM', 'Introduction to Data Structures', 'AB2-202', 'var(--success-color)', 'Vishal Singh', 'Period 2'),
            (2, '01:40 PM', '03:05 PM', 'Programming in Python', 'AB2-203', '#f472b6', 'Ujjwal Verma', 'Period 3'),
            (3, '09:00 AM', '10:30 AM', 'Introduction to Data Structures', 'AB2-101', 'var(--success-color)', 'Vishal Singh', 'Period 1'),
            (3, '10:40 AM', '12:10 PM', 'PDS Lab Sec4', 'Computer Lab', 'var(--accent-color)', 'Arjun Singh Gangwar', 'Period 2'),
        ...
        sec5_tt = [
            ...
            (0, '02:10 PM', '03:35 PM', 'Python and Data Structure (LAB)', 'Computer Lab', 'var(--accent-color)', 'John Smith', 'Period 3'),
