...
def insert_section7_students():
    ...
    with app.app_context():
        ...
        print(f"Adding students to {scds_school.name}, {section7.name} (ID: {section7.id})")

        # Load students from JSON
        with open('section7_students.json', 'r') as f:
        ...
        db.session.commit()
        print(f"\nFinished! Added {added_count} students to Section 7, skipped {skipped_count}.")

if __name__ == "__main__":
    insert_section7_students()
